...
def compute_HP4EDA_forAlldata_run1b(dataset_source, file_extension, lowIQR, highIQR, nBins):
	'''
	INTRODUCTION:
	...
	for i in np.arange(0, len(sorted_filepaths)):
		...
		#CONCATENATE ALL 3 DESCRIPTORS
		descriptor = np.hstack((count1, count3, count2))
...
allDb_Descriptors = compute_HP4EDA_forAlldata_run1b(dataset_testing, file_extension, lowIQR, highIQR, nBins)
